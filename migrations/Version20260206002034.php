 ...
 */
final class Version20260206002034 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE password_reset_token CHANGE user user_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE password_reset_token CHANGE user_id user INT NOT NULL');
    }
}
